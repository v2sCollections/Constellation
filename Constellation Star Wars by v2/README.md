...
- **2**) Go to the [Collection](https://next.nexusmods.com/starfield/collections/smp1fz?utm_source=copy\&utm_medium=social\&utm_campaign=share_collection) page and ensure the most current revision number is displayed, then select **"ADD TO VORTEX"**
...
<details><summary>CLICK FOR THE INSTALLATION GUIDE TO ADD THIS TO OUR MAIN COLLECTION</summary>
Install guide.
